...
export function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[280px] shrink-0 flex-col border-r border-white/5 bg-surface-deep px-6 py-8 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-on-surface-variant transition hover:bg-white/10 hover:text-on-surface lg:hidden"
